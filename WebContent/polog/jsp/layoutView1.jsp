...
<div class="row">
	...
	<div class="col-xs-1 col-xs-offset-2" style="width:370px; height:250px; border:1px solid #ced9ea;"> 
		<!-- 레이아웃 -->
		<div class="row" id="l1"  >
			<div class="col-xs-1 l1e1" ondrop="drop(event)" ondragover="allowDrop(event)" id="e1">
				
			</div>
			<div class="col-xs-1 l1e1" ondrop="drop(event)" ondragover="allowDrop(event)" id="e2">
				
			</div>
			
		</div> 
	</div>
	<div class="col-xs-1" style="width:100px; height:250px; padding-top:40px;"> 
